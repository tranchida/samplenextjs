        ...
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-14">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Link
                href="/"
                className={`text-white hover:text-blue-600 dark:hover:text-blue-300 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 ${pathname === '/' ? 'text-blue-600 dark:text-blue-300 font-semibold' : ''}`}
              >
                Home
              </Link>
              <Link
                href="/admin"
                className={`text-white hover:text-blue-600 dark:hover:text-blue-300 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 ${pathname === '/admin' ? 'text-blue-600 dark:text-blue-300 font-semibold' : ''}`}
              >
                Admin
              </Link>
              <Link
                href="/about"
                className={`text-white hover:text-blue-600 dark:hover:text-blue-300 px-3 py-2 rounded-md text-sm font-medium transition-colors duration-200 ${pathname === '/about' ? 'text-blue-600 dark:text-blue-300 font-semibold' : ''}`}
              >
                About
              </Link>
            </div>
